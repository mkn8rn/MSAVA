...
public class FileIngestionServiceTests
{
    ...
    [TestCase("http://192.0.0.8/file.txt")]
    [TestCase("http://192.0.2.10/file.txt")]
    [TestCase("http://192.88.99.1/file.txt")]
    [TestCase("http://198.51.100.10/file.txt")]
    [TestCase("http://203.0.113.10/file.txt")]
